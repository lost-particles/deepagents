...
_REPL_SYSTEM_PROMPT_TEMPLATE = (
    ...
    "- The final expression must not be an unresolved Promise. End with "
    "`await <expr>` or assign the awaited value to a variable — a bare "
    "`(async () => {{ ... }})();` at the end surfaces as `[object]`, not the "
    "resolved value.\n"
